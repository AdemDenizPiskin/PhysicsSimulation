...
y = path[1]
line, = ax.plot([50,x[0],50], [0,y[0],100],'b', marker='o', linestyle='dashed')
line2, = ax.plot([50,50],[0,100],'ro')


def animate(i):

    line.set_xdata([50,x[i],50])

    line.set_ydata([0,y[i],100] ) # update the data.
    return line,
